...
\leftheader{%
  {\LARGE\bfseries\sffamily Ziliang Xiong, Ph.D. Student}

  \makefield{\faEnvelope[regular]}{\href{mailto:ziliang.xiong@liu.se}{\texttt{ziliang.xiong@liu.se}}}
  %% Next line
  \makefield{\faLinkedin}{\href{http://linkedin.com/in/xzleo}{\texttt{linkedin.com/in/xzleo}}}
  \par 
  \makefield{\faGlobe}{\href{http://liu.se/en/employee/zilxi06}{\texttt{liu.se/en/employee/zilxi06}}}
  \makefield{\faGithub}{\href{https://github.com/XZLeo}{\texttt{github.com/XZLeo}}}
